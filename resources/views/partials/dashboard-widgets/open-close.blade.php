<style>
    ...
    .openCloseWidget .list-group-item{
        padding: 1.5%;
    }
    .dark .progress{
    ...
    .progress-bar{
        background-color: #4f8546;
    }
</style>
<div class="openCloseWidget">
    <div class="card dataContainer">
        @if (isset($data))
            <span style="font-weight:bold;text-align: center;font-size: 100%;color:#199c9e;">{{translator('CLOSING')}}</span>
            <ol class="list-group mt-2">
                <li class="list-group-item">
                    ...
                    <div class="progress mt-2" style="width:100%;background-color:#b3b5bd;">
